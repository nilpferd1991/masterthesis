...
\begin{table}
  ...
  \begin{tabular}{lcccc} \toprule
    ...
    Finding Efficiency   & 86.00 & 86.28 & 85.47 \\
    \quad on Primaries   & 91.59 & 92.11 & 91.39 \\ 
    Hit Efficiency       & 84.62 & 85.91 & 82.19 \\
    \quad on Primaries   & 90.20 & 91.56 & 87.40 \\ 
    Clone Rate           & 15.42 & 14.83 & 19.72 \\
    \quad on Primaries   & 7.29  & 7.68  & 17.27 \\ 
    Fake Rate            & 17.76 & 18.27 & 15.72 \\ 
...
\begin{figure}
  ...
  \caption{Finding efficiency over $p_T$ for the full path without and with the quality corrections applied after removing all not-fitted tracks. For comparison, also the efficiency before the fit and the quality tools is shown in blue.}
...
\begin{figure}
  ...
  \begin{tikzpicture}[>=latex']
    ...
    \node[anchor=south west, inner sep=0] at (0.1, 0.1) {\includegraphics[trim={10cm 5cm 8.8cm 13.8cm}, clip, scale=1]{figures/workflow/after_quality.pdf}};
    \draw[kit-red100,ultra thick,rounded corners] (1.8, 2) rectangle (2.8, 3);
    
    \draw[black, rounded corners, fill=white] (\x + 1, 0) rectangle (2*\x + 1, \y);
    \node[anchor=south west, inner sep=0] at (5.1, 0.1) {\includegraphics[trim={10.5cm 7.2cm 8.3cm 11.6cm}, clip, scale=1]{figures/workflow/after_quality.pdf}};
    ...
    \node[anchor=south west, inner sep=0] at (10.1, 0.1) {\includegraphics[trim={4.5cm 10.2cm 8.6cm 2.9cm}, clip, scale=0.4]{figures/workflow/after_quality.pdf}};
    
%     \draw[->, thick] (\x - 0.05, \y - 0.05) -- (\x + 3.25, \y + 4.5);
%     \draw[->, thick] (2*\x, \y) -- (\x + 3.75, \y + 5.75);
...
\begin{table}
  \caption{Figures of merit of the two quad tree implementations with segments (for axial hits only) in comparison to the axial Legendre track finder. As expected, the quad trees with segments perform worse.}
  \begin{tabular}{lcccc} \toprule
    & Full Path & Parameters & Averaged Position & Region Check \\ \midrule
    Finding Efficiency   & 88.33 & 48.47 & 35.49 & 60.12 \\
    \quad on Primaries   & 93.83 & 52.45 & 39.34 & 65.98 \\ 
    Hit Efficiency       & 49.56 & 25.24 & 37.60 & 40.13 \\
    \quad on Primaries   & 52.79 & 25.47 & 38.54 & 41.21 \\ 
    Clone Rate           & 14.46 & 15.43 & 9.06  & 11.32 \\
    \quad on Primaries   & 7.43  & 17.24 & 15.50 & 11.11 \\ 
    Fake Rate            & 16.68 & 14.43 & 52.10 & 26.03 \\ 
    Wrong Hits per Track & 1.24  & 1.17  & 8.23  & 3.97 \\ 
    Time per Event in ms & 32.34 & 16.68 & 20.94 & 42.64\footnotemark \\ \bottomrule
  \end{tabular}
