...
\begin{figure}
  ...
  \begin{tikzpicture}[thick]
    ...
    \node[module, below=1 of hits, text width=12em] (segment) {{Segment\-Finder\-CDC\-Facet\-Automaton}};
    ...
    \node[module, below=1 of stereo, text width=12em] (combiner) {{Segment\-Track\-Combiner}};
...
\begin{figure}
  \centering
  \includegraphics[width=0.48\linewidth]{figures/workflow/event_display_finder.png}
  \includegraphics[width=0.48\linewidth]{figures/workflow/event_display_mc.png}

  \includegraphics[width=0.48\linewidth]{figures/workflow/event_display_finder_2.png}
  \includegraphics[width=0.48\linewidth]{figures/workflow/event_display_mc_2.png}
